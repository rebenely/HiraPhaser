class HiraText extends Phaser.GameObjects.Text {
    constructor(scene, x, y, text, type, wordWrapWidth) {
        ...
        switch(type) {
            case "basic":
                style = { font: "18px manaspc", fill:  game.global.UI_TEXT_FILL };
            break;
            case "header":
                style = { font: "32px manaspc", fill: game.global.UI_TEXT_FILL, align: "center" };
            break;
            case "wordWrap":
                style = { font: "18px manaspc", fill: game.global.UI_TEXT_FILL, align: "center", wordWrap: { width: wordWrapWidth, useAdvancedWrap: true} };
            break;
            case "wordWrapL":
                style = { font: "18px manaspc", fill: game.global.UI_TEXT_FILL, align: "left", wordWrap: { width: wordWrapWidth, useAdvancedWrap: true} };
            break;
        }
